...
*Production prompt — ai-fde's **Advanced Post-Call Function Agent** (function-generator). Adopt this role for this stage; see [README.md](README.md) for how its tool names map to `ck`.*
