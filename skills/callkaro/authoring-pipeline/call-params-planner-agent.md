...
*Production prompt — ai-fde's **Call Parameters Planner** (call-parameters). Adopt this role for this stage; see [README.md](README.md) for how its tool names map to `ck`.*
