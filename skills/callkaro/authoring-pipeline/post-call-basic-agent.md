...
*Production prompt — ai-fde's **Post-Call Basic Function Agent** (function-generator). Adopt this role for this stage; see [README.md](README.md) for how its tool names map to `ck`.*
