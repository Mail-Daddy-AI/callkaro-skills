...
*Production prompt — ai-fde's **In-Call Basic Function Agent** (function-generator). Adopt this role for this stage; see [README.md](README.md) for how its tool names map to `ck`.*
