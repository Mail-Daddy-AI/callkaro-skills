...
*Production prompt — ai-fde's **Predefined Functions Agent** (function-generator). Adopt this role for this stage; see [README.md](README.md) for how its tool names map to `ck`.*
